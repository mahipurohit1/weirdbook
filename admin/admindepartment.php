...
?>    </div>
      <!-- BEGIN : MAIN CONTENT -->
      <h1 class=" my-6 mx-auto px-4 md:px-12 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Department List</h1>
  ...
  <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
    <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
      ...
      <div class="modal-body relative p-4">
       <form action="../php/insertdepartment.php" METHOD="POST">
       <div class="mb-6">
...
<div class="p-6 mt-3 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><?php echo $row['dept_name']?></h5>
  
    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"> Here you can find all the reading material semester wise  of the computer department, click on read more...</p>
    <a href="<?php echo "adminsem.php?id=" . $ENC_ID ?>" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Read more
