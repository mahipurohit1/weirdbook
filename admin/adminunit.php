...
?>
      ...
      <!-- BEGIN : MAIN CONTENT -->
      <h1 class=" my-6 mx-auto px-4 md:px-12 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Unit List</h1>
  ...
  <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
    <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
      ...
      <div class="modal-body relative p-4">
       <form action="<?php echo "../php/insertunit.php?id=" . $n ?>" METHOD="POST">
       <!-- <div class="mb-6">
       ...
       <div class="mb-6">
            ...
            <input
              ...
              name="unit"
              class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
              placeholder="Enter unit name like unit 1 : intro xyz "
            />
          </div>
          <input
            type="submit"
        ...
        ?>
          ...
          <div class="chat__chat-list overflow-y-auto scrollbar-hidden pr-1 pt-1 mt-4">
            <div class="card intro-x mt-4 cursor-pointer box relative flex p-3 ">
              ...
              <a href="<?php echo "admindocument.php?id=" . $ENC_ID ?>">
