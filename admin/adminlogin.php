...
<section class="h-screen">
  ...
  <h1 class="text-5xl flex  items-center justify-center  font-bold mt-0 mb-6">Admin Login </h1>
    <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
      ...
      <div  id="loginerror"class="bg-red-100 hidden border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
      <span class="block sm:inline">Incorrect email and password </span>
